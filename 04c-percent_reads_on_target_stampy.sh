...
cd /work/jelber2/immunome/stampy-alignment
...
export itotalmappedreads="$(awk NR==3 $i.stampy.bam.flagstat | grep -Po '^\d+')" #3b. creates the bash variable itotalmappedreads
