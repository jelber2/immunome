...
04a-clean_sort_addRG.py - version 1.0 : limited ram to 2GB per core

Command:
cd InDir = /work/jelber2/immunome/stampy-alignment
1.Uses samtools merge to combine stampy bam files
        ~/bin/samtools-0.1.19/samtools merge -@ 1\
...
~/scripts/immunome/04a-clean_sort_addRG.py *.stampy.bam
