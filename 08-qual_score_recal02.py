...
File Info
InDir = /work/jelber2/immunome/call-SNPs-recal01
Input Files =
       Sample-recal01.bam
       ../call-SNPs-recal01/ALL-samples-recal01-Q30-SNPs.vcf
OutDir = /work/jelber2/immunome/call-SNPs-recal02
Output Files = Sample-recal02.bam


Usage (execute following code in InDir):

find . -name '*-recal01.bam' -not -name 'ALL-samples-*' -exec ~/scripts/immunome/08-qual_score_recal02.py {} \;
